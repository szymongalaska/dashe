<div
    class="absolute hidden invisible lg:left-1/2 transform -translate-x-1/2 top-8 group-hover:opacity-100 group-hover:visible group-hover:block z-10 max-w-64 md:max-w-80 inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-xs opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
