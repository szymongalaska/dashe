<x-configuration-layout>
    <div
        class="flex flex-col justify-between items-center w-11/12 sm:max-w-xl sm:my-6 px-6 py-4 bg-white dark:bg-gray-800 dark:text-gray-200 shadow-md overflow-hidden rounded-lg space-y-6">
